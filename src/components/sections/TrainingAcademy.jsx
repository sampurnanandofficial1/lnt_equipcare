...
const ROLES = [
  { role:'Operator',    color:'bg-lt-red',   mods:8,  topics:['Safe Operations','Fuel Efficiency','Daily Inspection','Productivity'] },
  ...
  return (
    <section className="py-20 bg-lt-gray-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              <ul className="space-y-1.5 flex-1">
                {r.topics.map(t => (
                  <li key={t} className="flex items-center gap-2 text-sm text-lt-gray-dark font-body">
                    <Play size={10} className="text-lt-red fill-lt-red flex-shrink-0"/>{t}
                  </li>
                ))}
              </ul>
              <div className="flex items-center gap-1.5 mt-4 text-xs font-body font-semibold text-lt-red border-t border-lt-gray-border pt-3">
        ...
        {/* ATC callout */}
        <div className="card border-t-4 border-lt-red p-6 sm:p-8 text-center max-w-3xl mx-auto">
          ...
          <button className="btn-red inline-flex items-center gap-2 mx-auto">
